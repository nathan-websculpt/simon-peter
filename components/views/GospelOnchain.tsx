  ...
  return (
    <>
      <article>
        ...
        <div className="w-full lg:w-4/5 ml-6 lg:ml-8 xl:ml-12 mt-8 lg:mt-12 flex flex-col prose xl:prose-xl">
          ...
          <p>
            I am working towards decentralized and distributed solutions that
            can protect text against tyranny, and I firmly believe that the
            blockchain could provide a decentralized and immutable record of the
            Bible &mdash; a way to ensure that the scriptures are:
          </p>
          <ul>
            <li>unbannable</li>
            <li>unburnable</li>
          ...
          <p>
            Making books/documents unbannable can mean that everyone has access
            to them &mdash; regardless of geopolitical or ideological
            restrictions. Readers all over the world could freely engage with
            these texts without fear of censorship.
          </p>
          <Link
          ...
          <p>
            I feel strongly that a council-of-members should vote
            (verse-by-verse) on each book before a single sentence is considered
            confirmed, but without teams of people willing to be a part of it
            and people willing to fund it, I have currently been reduced to
            storing these books myself and allowing for the ability to confirm
            verses after the fact.
          </p>
          <p>
            I love the idea of doing this with a council, and you can see the
            code for that project here:{" "}
            <Link
          ...
          <p>
            And this repo to see how a (self-governed) council-of-members can
            have access to donations: <span> </span>
            <a
